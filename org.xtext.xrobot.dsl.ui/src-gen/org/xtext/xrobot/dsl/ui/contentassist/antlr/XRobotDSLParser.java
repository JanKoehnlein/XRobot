...
* generated by Xtext
*/
package org.xtext.xrobot.dsl.ui.contentassist.antlr;
...
public class XRobotDSLParser extends AbstractContentAssistParser {
	...
	@Override
	protected org.xtext.xrobot.dsl.ui.contentassist.antlr.internal.InternalXRobotDSLParser createParser() {
		org.xtext.xrobot.dsl.ui.contentassist.antlr.internal.InternalXRobotDSLParser result = new org.xtext.xrobot.dsl.ui.contentassist.antlr.internal.InternalXRobotDSLParser(null);
		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getProgramAccess().getFunctionsAssignment_5_0(), "rule__Program__FunctionsAssignment_5_0");
					put(grammarAccess.getProgramAccess().getVariablesAssignment_5_1(), "rule__Program__VariablesAssignment_5_1");
					...
					put(grammarAccess.getVariableAccess().getInitializerAssignment_3_1(), "rule__Variable__InitializerAssignment_3_1");
	...
	protected Collection<FollowElement> getFollowElements(AbstractInternalContentAssistParser parser) {
		try {
			org.xtext.xrobot.dsl.ui.contentassist.antlr.internal.InternalXRobotDSLParser typedParser = (org.xtext.xrobot.dsl.ui.contentassist.antlr.internal.InternalXRobotDSLParser) parser;
