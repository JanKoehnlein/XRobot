...
@parser::members {
    ...
    public InternalXRobotDSLParser(TokenStream input, XRobotDSLGrammarAccess grammarAccess) {
        this(input);
    ...
    protected String getFirstRuleName() {
   	...
   	@Override
   	protected XRobotDSLGrammarAccess getGrammarAccess() {
...
(
    ...
    {
    	newLeafNode(otherlv_1, grammarAccess.getProgramAccess().getRobotKeyword_1());
    }
((
(
		lv_name_2_0=RULE_ID
		{
			newLeafNode(lv_name_2_0, grammarAccess.getProgramAccess().getNameIDTerminalRuleCall_2_0_0()); 
		}
		{
	        if ($current==null) {
...
(
		...
		{
			newLeafNode(lv_name_3_0, grammarAccess.getProgramAccess().getNameSTRINGTerminalRuleCall_2_1_0()); 
		}
		{
	        if ($current==null) {
	            $current = createModelElement(grammarAccess.getProgramRule());
    ...
    {
    	newLeafNode(otherlv_4, grammarAccess.getProgramAccess().getAuthorKeyword_3());
    }
((
(
		lv_author_5_0=RULE_ID
		{
			newLeafNode(lv_author_5_0, grammarAccess.getProgramAccess().getAuthorIDTerminalRuleCall_4_0_0()); 
		}
		{
	        if ($current==null) {
	            $current = createModelElement(grammarAccess.getProgramRule());
...
(
		...
		{
			newLeafNode(lv_author_6_0, grammarAccess.getProgramAccess().getAuthorSTRINGTerminalRuleCall_4_1_0()); 
		}
		{
	        if ($current==null) {
	            $current = createModelElement(grammarAccess.getProgramRule());
...
(
		{ 
	        newCompositeNode(grammarAccess.getProgramAccess().getModesModeParserRuleCall_5_2_0()); 
	    }
...
(
    ...
    {
    	newLeafNode(otherlv_1, grammarAccess.getModeAccess().getOnKeyword_1_0());
    }
(
(
		{ 
	        newCompositeNode(grammarAccess.getModeAccess().getConditionXExpressionParserRuleCall_1_1_0()); 
	    }
...
(
		{ 
	        newCompositeNode(grammarAccess.getModeAccess().getActionXBlockExpressionParserRuleCall_2_0()); 
	    }
...
(    this_ID_0=RULE_ID    {
    ...
    {
        $current.merge(kw);
        newLeafNode(kw, grammarAccess.getValidIDAccess().getRobotKeyword_1()); 
    }
    ...
    {
        $current.merge(kw);
        newLeafNode(kw, grammarAccess.getValidIDAccess().getAuthorKeyword_2()); 
    }
    ...
    {
        $current.merge(kw);
        newLeafNode(kw, grammarAccess.getValidIDAccess().getOnKeyword_3()); 
    }
    ...
    {
        $current.merge(kw);
        newLeafNode(kw, grammarAccess.getValidIDAccess().getWhenKeyword_4()); 
    }
